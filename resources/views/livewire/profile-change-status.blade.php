        ...
        <div class="mt-5">
            ...
            @else
                <div class="flex flex-row justify-between items-center mb-5">
                    <input id="profile_link" type="text" id="disabled-input" aria-label="disabled input" class="mr-5 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full cursor-not-allowed" 
